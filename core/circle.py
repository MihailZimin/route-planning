...
class Circle(ABCGeo):
    ...
    def __init__(self, center: Point, radius: float) -> None:
        ...
        Raises:
            ValueError if radius does not fit in certain range
            TypeError if center is not type of Point

        """
        BasicValidationFunctions.check_radius(radius)
        Point.check_point_instance(center)
        self._radius = radius
        self._center = center
